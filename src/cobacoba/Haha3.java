...
public class Haha3 {
 ...
 private int jmlbaris=7;  
 private int jmlkolom=7;
 ...
 //Method untuk inisialisasi
  ...
  private boolean cekBarisPemenang(){
   for(int i = 0; i < jmlbaris; i++){
    ...
    if(cekBarisKolom(papan[i][0],papan[i][2],papan[i][2],papan[i][3],papan[i][4],papan[i][5],papan[i][6]) == true){
     return true;
  ...
  private boolean cekKolomPemenang(){
   for(int i = 0; i < jmlkolom; i++){
    ...
    if(cekBarisKolom(papan[1][i], papan[1][i], 
      papan[2][i],papan[3][i],papan[4][i],papan[5][i],papan[6][i]) == true){
     return true;
  ...
  private boolean cekDiagonalPemenang(){
   return((cekBarisKolom(papan[0][0], papan[1][1], 
     papan[2][2],papan[3][3],papan[4][4], papan[5][i], papan[6][i]) == true)
     || (cekBarisKolom(papan[0][2], papan[1][1], 
       papan[2][0], papan[3][3], papan[4][4], papan[5][i], papan[6][i]) == true) );
  }//Akhir method cekDiagonalPemenang
  
  
  //Method untuk mengecek tiga nilai adalah sama
  //dan tidak kosong pada baris atau kolom
  private boolean cekBarisKolom(char a1, char a2, char a3, char par3, char par4, char par7, char par8){
